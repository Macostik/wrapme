...
- (void)viewDidLoad {
    ...
    [self.dataSource.autogeneratedPlaceholderMetrics setFinalizeAppearingBlock:^(StreamItem *item, id entry) {
        item.view.layer.geometryFlipped = streamView.layer.geometryFlipped;
    }];
    
    [self.dataSource.autogeneratedMetrics setFinalizeAppearingBlock:^(StreamItem *item, id entry) {
        item.view.layer.geometryFlipped = streamView.layer.geometryFlipped;
    }];
