...
- (void)setEntry:(WLCandy *)entry {
    [self.photoByLabel setText:[NSString stringWithFormat:[entry messageAppearanceByCandyType:@"formatted_video_by"
                                                                                          and:@"formatted_photo_by"], entry.contributor.name]];
