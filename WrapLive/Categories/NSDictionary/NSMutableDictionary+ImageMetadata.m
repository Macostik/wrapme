...
- (id)initWithImageSampleBuffer:(CMSampleBufferRef) imageDataSampleBuffer {
	...
	self = [self initWithDictionary:(__bridge NSDictionary *)(metadata)];
	CFRelease(metadata);
	return self;
}
...
- (NSMutableDictionary *)infoForKey:(CFStringRef)key {
...
#define EXIF_DICT [self infoForKey:kCGImagePropertyExifDictionary]
#define TIFF_DICT [self infoForKey:kCGImagePropertyTIFFDictionary]
#define IPTC_DICT [self infoForKey:kCGImagePropertyIPTCDictionary]
...
- (void)setImageOrientation:(UIImageOrientation)orientation {
    ...
    [self setObject:[NSNumber numberWithInt:o] forKey:(id)kCGImagePropertyOrientation];
    [[self objectForKey:(id)kCGImagePropertyTIFFDictionary] setValue:[NSNumber numberWithInt:o] forKey:(id)kCGImagePropertyTIFFOrientation];
}
