...
+ (CGFloat)heightWithComment:(WLComment *)comment {
    ...
    CGFloat height = [comment.text heightWithFont:[UIFont preferredFontWithName:WLFontOpenSansLight preset:WLFontPresetNormal] width:WLTimelineEventCommentsMinWidth];
