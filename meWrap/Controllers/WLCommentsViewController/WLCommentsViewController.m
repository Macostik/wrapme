...
- (void)viewDidLoad {
    ...
    [self.dataSource.autogeneratedPlaceholderMetrics setFinalizeAppearing:^(StreamItem *item, id entry) {
        item.view.layer.geometryFlipped = streamView.layer.geometryFlipped;
    }];
