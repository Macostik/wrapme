...
//  meWrap
//
//  Created by Ravenpod on 7/22/15.
...
-(UICollectionReusableView *)collectionView:(UICollectionView *)collectionView viewForSupplementaryElementOfKind:(NSString *)kind atIndexPath:(NSIndexPath *)indexPath {
    ...
    } else if ([kind isEqualToString:@"WLHottestWrapHeader"]) {
        return [collectionView dequeueReusableSupplementaryViewOfKind:kind withReuseIdentifier:@"WLHottestWrapHeader" forIndexPath:indexPath];
    }
    return nil;
}
...
- (CGSize)collectionView:(UICollectionView*)collectionView sizeForSupplementaryViewOfKind:(NSString*)kind atIndexPath:(NSIndexPath*)indexPath {
    ...
    } else if ([kind isEqualToString:@"WLHottestWrapHeader"] && indexPath.item == 0) {
