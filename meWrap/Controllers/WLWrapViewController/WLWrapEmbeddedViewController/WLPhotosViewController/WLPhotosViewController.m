    ...
    if (historyItem) {
        ...
        if (index != NSNotFound) {
            ...
            StreamItem *item = [self.dataSource.streamView itemPassingTest:^BOOL(StreamItem *item) {
                return item.position.index == index && item.metrics == weakSelf.dataSource.autogeneratedMetrics;
            }];
            if (scroll) {
            ...
            if (candiesCell) {
                ...
                if (index != NSNotFound) {
                    item = [candiesCell.dataSource.streamView itemPassingTest:^BOOL(StreamItem *item) {
                        return item.position.index == index && item.metrics == candiesCell.candyMetrics;
                    }];
                    if (scroll) {
