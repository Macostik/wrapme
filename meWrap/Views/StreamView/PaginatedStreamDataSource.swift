...
//extension StreamDataSource where T: PaginatedListProtocol {
//    var appendableBlock: (StreamDataSource<T> -> Bool)?
//    
...
//    }()
//    
//    override var items: PaginatedList<T>? {
//        didSet {
//            if let set = items {
...
//    }
//    
//    func refresh(success: ([T] -> ())?, failure: FailureBlock?) {
//        items?.newer(success, failure: failure)
//    }
//    
//    func append(success: ([T] -> ())?, failure: FailureBlock?) {
