...
extension StreamDataSource {
    ...
    func streamView(streamView: StreamView, numberOfItemsInSection section: UInt) -> UInt {
        if let numberOfItems = numberOfItems {
            return numberOfItems.unsignedIntegerValue
        } else {
    ...
    func streamView(streamView: StreamView, headerMetricsInSection section: UInt) -> [StreamMetrics] {
        return sectionHeaderMetrics
    }
    
    func streamView(streamView: StreamView, footerMetricsInSection section: UInt) -> [StreamMetrics] {
    ...
    func streamViewNumberOfSections(streamView: StreamView) -> UInt {
        return 1
    }
}
